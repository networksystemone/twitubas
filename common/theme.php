...
function theme_css() {
	...
	a{color:#{$c->links};text-decoration:none}
	...
	.info{font-size:16px;color:#{$c->bodyt};background:#{$c->replyodd};margin: 0.3em; padding: 0.1em 0.5em;border:3px solid #ccc}
	.info a{color:#{$c->links};font-size: 18px;font-weight:bold;text-decoration:none}a:hover{color:#fff;background-color:#{$c->ahvrbg}}

	.menuy{color:#111;background:#151515 url(http://twit.basko.ro/imgtop/bgmenu.gif?v2) 0 0 repeat-x;height:29px; 0 0 0;}
	.menuy a{color:#fff;float:left;display:block;width:20%;}
