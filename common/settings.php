...
function settings_page($args) {
	if ($args[1] == 'save') {
		...
		$settings['ref_per'] 	 = $_POST['ref_per'];
	...
	$refresh_period = setting_fetch('ref_per');
...
*/
	...
	$content .= '<p><label>Rentang Waktu untuk Autorefresh:<br/> <input type="text" name="ref_per" value="'.$refresh_period.'" size="2" /> detik.</label><small><br />Kosongkan (blank) untuk nonaktifkan auto refresh.</small></p>';
